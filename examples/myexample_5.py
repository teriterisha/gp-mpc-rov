...
"""这段代码与4相同功能，区别是进行了整理，将函数归类到了不同文件
"""
...
state_l = [-np.inf, -np.inf, -np.inf, -4., -1.0, -np.pi / 2] 
state_u = [np.inf, np.inf, np.inf, 4., 1.0, np.pi / 2] 
control_l = [-100.0, -100.0, -5.0]   
control_u = [100.0, 100.0, 5.0]    
