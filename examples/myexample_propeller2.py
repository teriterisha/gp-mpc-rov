...
xlb = [-2.5, -1.5, -np.pi / 4]    # state bound
xub = [2.5, 1.5, np.pi / 4]      # state bound
...
# np.save('X_test_propeller_15.npy',X_test)
# np.save('Y_test_propeller_15.npy',Y_test) 
"""2中存储了一组较好的数据"""
...
ode_error_ca = get_ode_ca_distrub(ode_error_distrub_propeller, x_distrub, y_distrub, Nx + 1, Nu)
