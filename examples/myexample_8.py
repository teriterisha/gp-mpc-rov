...
# 模型准确但无干扰
ode_real_no_dis_ca = get_ode_ca(ode_real, 3, 3)
kine_real_no_dis_ca = dyna_2_kine_nominal(ode_real_no_dis_ca, 3, 3)
...
control_l = [-100.0, -100.0, -10.0]   
control_u = [100.0, 100.0, 10.0]    
